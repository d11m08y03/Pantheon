...
export default function Events({ eventData }: { eventData: EventData }) {
  return (
    <motion.div
      ...
      className="relative overflow-hidden rounded-lg bg-white shadow-lg transition-shadow duration-300 hover:shadow-xl ml-1 mr-1 w-full sm:w-[350px] lg:w-[400px] h-[450px] sm:h-[500px] lg:h-[500px]"
    >
