...
export default function UpcomingEvents({ eventData }: { eventData: UpcomingEvents }) {
  return (
    <motion.div
      ...
      className="relative overflow-hidden rounded-lg bg-white shadow-lg transition-shadow duration-300 hover:shadow-xl mb-10 mt-10 ml-1 mr-1 w-full sm:w-[350px] lg:w-[400px] h-[450px] sm:h-[500px] lg:h-[550px]"
    >
      {/* Event Image */}
